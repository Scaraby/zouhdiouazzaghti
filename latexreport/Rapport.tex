...
\par\leavevmode\
	...
	La commande generateMap charge la Layer map, initialement, à partir d'un fichier .txt. L'implantation des layers de jeu (points de vie), et des layers de personnage se feront sans doute de la même manière.
