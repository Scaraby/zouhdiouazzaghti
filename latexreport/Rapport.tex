...
\begin{itemize}
   ...
   \par\leavevmode\
    ...
    \item  \textbf{Les élements de mur} (classe Wall), définissant les zones infranchissables où le personnage ne peut se déplacer. IL peut s'agir d'un obstacles (arbre) ou tout simplement d'un bord de la map. (\textit{e.g}  mur)
